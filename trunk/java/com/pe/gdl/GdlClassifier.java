...
public class GdlClassifier implements Serializable
{
	...
	public static GdlClassifier BuildClassifier(String ClassifierName, String Dataset, int TestType, int TestParam) throws Exception
	{
		...
		GdlClassifier Classifier = new GdlClassifier();
