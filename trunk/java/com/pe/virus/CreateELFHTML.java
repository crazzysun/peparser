 ...
 *
 */
public class CreateELFHTML
{
	private static Log log = LogFactory.getLog(CreateELFHTML.class);
	
	private ELFTrainSet trainSet;
	
	public CreateELFHTML(ELFTrainSet trainSet)
	{
	...
	public void create() throws Exception
	{
		...
		/** 生成分析结果 */
		String pathName = SystemConfigure.get("ELFVirusResultHome");
