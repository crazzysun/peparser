 ...
 *
 */
public class CreateGdlHTML
{
	private static Log log = LogFactory.getLog(CreateGdlHTML.class);
	
	private GdlTrainSet trainSet;
	
	public CreateGdlHTML(GdlTrainSet trainSet)
	{
	...
	public void create() throws Exception
	{
		...
		/** 生成分析结果 */
		String pathName = SystemConfigure.get("GdlResultHome");
	...
	private String replaceValue(String templateContent)
	{
		...
		String strTemp = "";
		List<GdlResultShow> resultShow = trainSet.getResultShow();
		
		for (int i = 0; i < resultShow.size(); i++)
		{
			strContentData = strContentTemplate;
			GdlResultShow result = resultShow.get(i);
