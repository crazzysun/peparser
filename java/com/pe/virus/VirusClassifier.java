...
public class VirusClassifier implements Serializable
{
	...
	public static VirusClassifier BuildClassifier(String ClassifierName, String Dataset, int TestType, int TestParam) throws Exception
	{
